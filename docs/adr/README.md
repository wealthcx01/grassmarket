...
ADR-0003 through ADR-0007 are folded into `docs/ATLAS-Methodology-v1.1.md`, which supersedes v1.0
and is normative for the scoring engine. Where an ADR and the Methodology disagree, the Methodology
wins and the ADR is a defect.
