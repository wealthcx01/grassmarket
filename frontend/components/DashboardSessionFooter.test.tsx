...
describe("DashboardSessionFooter (GRS-0037)", () => {
  beforeEach(() => vi.clearAllMocks());

  it("shows the sign-in link when there is no token", async () => {
  ...
  it("shows a sign-out control when signed in (not 'not signed in')", async () => {
